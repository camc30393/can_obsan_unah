/* ============================================================================
   ...
   datos/can_2024.json — no hay textos hard-coded por departamento; el
...
function AnalysisBox({ data, indicator, selected }) {
  ...
  return (
    <section className="analysis-box" aria-live="polite">
      ...
      {selected && data.departamentos[selected] && window.SANAlerts && (
        <window.SANAlerts dep={data.departamentos[selected]} total={data.total} />
      )}
    </section>
  );
}
